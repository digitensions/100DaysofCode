...
'''
Calculator(passive income desired, yearly investments, year start, apartment cost, annual rental income)
Range calculations will work out annual calculations to see accumulative wealth.
self._calculator_data_one: {year: [number of apartments owned, and total rental income]} ** keys of dictionary
'''
...
class TestCalculate(unittest.TestCase):
	...
	def setUp(self):
		...
		self._calculator_data_one = {2019: [0, 70000],
                                 2020: [1.0, 66666],		# 140,000 - 80,000 + 6666
                                 2021: [2.0, 69998],
                                 2022: [3.0, 79996],
                                 2023: [4.0, 96660],
                                 2024: [6.0, 46656],
	...
	def test_calculate_medium_first(self):
		with self.assertRaises(TypeError):
			Calculator("11111", "11111", "222222", "33333", "44")
	
	def test_calculate_medium_second(self):
		with self.assertRaises(TypeError):
			Calculator(15000, 70000, 2019.3, 80000, 6666)

	def test_calculate_medium_third(self):
		with self.assertRaises(TypeError):
			Calculator(15000, 70000, 2019, 80000, None)
	...
	def test_calculate_hard_second(self):
		with self.assertRaises(TypeError):
			Calculator(11111, None, None, None, None)
	
	def test_calculate_hard_third(self):
		with self.assertRaises(TypeError):
			Calculator(151111, 5656, 354346, 32324, Exception)
...
class TestGetYearsNeeded(unittest.TestCase):
	...
	def test_years_needed_easy_first(self):
		# Calculator class with method get_years_needed method required, and needs to return 15 years
...
class TestGetApartmentsNeeded(unittest.TestCase):
	...
	def test_apartments_needed_easy_first(self):
		# In Calculator class, get_apartments_needed method calculates this
...
class TestGetNetWorth(unittest.TestCase):
	...
	def test_net_worth_easy_first(self):
		# assets accrued by apartment purchases (no inflation/depreciation)
